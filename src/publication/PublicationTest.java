...
class PublicationTest extends TestCase{
	//Test #: 1
		...
		//Inputs: publicationName = "Publication1", price=1000.0
		//Expected Output: Publication Object created with publicationName = "Publication1",price=1000.0
	@Test
	public void testValidPublication001() {
		try {
			Publication publication = new Publication("Publication1",1000.0);
